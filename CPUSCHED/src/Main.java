...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            File outputDir = new File("CPUSCHED/output");
            if (!outputDir.exists()) {
                outputDir.mkdirs();
            }
            ...
            // --------- FIFO Phase ---------
            PrintStream fifoOut = new PrintStream(new FileOutputStream("CPUSCHED/output/fifo_output.txt"));
            ...
            BufferedReader fifoReader = new BufferedReader(new FileReader("CPUSCHED/output/fifo_output.txt"));
            String line;
            ...
            // --------- SJF Phase ---------
            PrintStream sjfOut = new PrintStream(new FileOutputStream("CPUSCHED/output/sjf_output.txt"));
            ...
            BufferedReader sjfReader = new BufferedReader(new FileReader("CPUSCHED/output/sjf_output.txt"));
